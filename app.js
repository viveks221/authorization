...
const auth = helpers.module.auth;
const log = logger('app:main');
const functionName = "appJs";
const passport = helpers.module.passport
const GoogleStrategy = helpers.module.GoogleStrategy;
const session = helpers.module.session;
...
function(req, accessToken, refreshToken, profile, cb) {
  const googleDetails={};
  googleDetails.googleToken = accessToken;
  googleDetails.profile = profile;
  googleDetails.refreshToken = refreshToken;
